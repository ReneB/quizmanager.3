...
ActiveRecord::Schema.define(version: 20160712131424) do
  ...
  create_table "content_images", force: :cascade do |t|
    ...
    t.index ["question_id"], name: "index_content_images_on_question_id", using: :btree
  end
  ...
  create_table "learnables_questions", force: :cascade do |t|
    t.integer "learnable_id"
    t.integer "question_id"
    t.index ["learnable_id"], name: "index_learnables_questions_on_learnable_id", using: :btree
    t.index ["question_id"], name: "index_learnables_questions_on_question_id", using: :btree
  end
